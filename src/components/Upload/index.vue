<template>
  ...
  <div>
    <el-upload  class="upload-demo" name="avatar" action="/api/upload" :multiple="multiple" :on-preview="handlePreview"
      :on-remove="handleRemove" :show-file-list="false" :before-remove="beforeRemove" :on-change="handleChange" :limit="limit" :drag="drag" :on-exceed="handleExceed" :before-upload="beforeUpload">
       <!-- 上传按钮 -->
       <div v-if="drag">

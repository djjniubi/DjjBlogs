 ...
 * @LastEditTime: 2023-07-21 17:33:10
-->
<template>
  <div class="view-l">
    <div class="view-item1"></div>
    <div class="view-item2">
      <div class="column-center-center" style="width: 190px; height: 100%">
        <div style="position: relative">
          ...
          <div style="width: 110px; height: 56px;position: absolute;bottom: -25px;left: 10px;">
            <img src="../../../assets/icons/圆.svg" alt="" />
          </div>
        </div>
        <div>
            <div class="row-start-end" style="color: white;margin-top: 56px;">
                ...
                <div style="display: flex;justify-content: start;align-items:end;">
                    <span style="font-size: 36px;color: #58DBFF; font-weight: 700;">12</span>
            ...
            <div class="row-start-end" style="color: white;margin-top: 12px;">
                <p style="font-size: 14px;margin-right: 25px;">高风险部门</p>
                <p style="font-size: 36px;color: #58DBFF; font-weight: 700;">12</p>
                <p style="font-size: 18px;color: #58DBFF; font-weight: 700;">个</p>
            </div>
            <div class="row-start-end" style="color: white;margin-top: 12px;">
                <p style="font-size: 14px;margin-right: 25px;">高风险部门</p>
...
function renderPieChart():EChartsOption{
    return{
        graphic:[{
            type:"text",
            top:'40%',
        ...
        series:[
            {type:"pie",data:[{value:100}],radius:["70%","100%"],color:"#FCB223",emphasis:{scale:false}}
        ]
    }
}

onMounted(()=>{
    nodeElemt("#lfet-box",renderPieChart())
})
</script>
